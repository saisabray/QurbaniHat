...
const Banner = () => {
  return (
    <div
      className="hero w-full h-[92vh] bg-cover bg-center "
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="hero-content text-neutral-content text-center">
        <div className="max-w-md">
          <h1 className="mb-5 text-5xl font-bold text-[hsl(0,0%,98%)]">
            Your Trusted <br />
          </h1>
          <h1 className="mb-5 text-5xl font-bold text-[#00521b]">
            Qurbani Partner
          </h1>
          <p className="mb-5 text-[#fff9f9]">
